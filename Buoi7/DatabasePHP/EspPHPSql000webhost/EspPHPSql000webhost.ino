...
void Send_Data_PHP(String nhietdo , String doam , String anhsang , String relay1 , String relay2)
{
  ...
  //http://toannv10291.000webhostapp.com/InsertDB.php
  http.begin("http://toannv10291.000webhostapp.com/InsertDB.php");
...
{
  HTTPClient http;
  const char* host = "http://toannv10291.000webhostapp.com/Getdatadieukhien.php";
  http.begin(host);
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");
